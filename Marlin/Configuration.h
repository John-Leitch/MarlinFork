...
#define STRING_CONFIG_H_AUTHOR "(John Douglas Leitch, Hallowed)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 25600, 93 }
 ...
 *     O-- FRONT --+
 */
// #define NOZZLE_TO_PROBE_OFFSET { -43, -11, -1.8 }
#define NOZZLE_TO_PROBE_OFFSET { -43, -11, -1.65 }
...
// For directdrive  extruder v9 set to true, for geared extruder set to false.
